...
export const projects = [
    {
        ...
        description:"Vegan Somtimes is a wordpress site built using Javascript, HTML, CSS, and PHP.  It's a recipe repository as well as a blog that helps answer questions for users who are looking to adopt a vegan lifestyle.",
        projectimage:"/assets/images/vegansometimesscreenshot.png",
        onedescription:"A wordpress site and vegan blog that enables users to search vegan recipes",
        projectprompt:"Design and deploy a website that hosts a vegan blog and is a vegan recipe repository.",
    ...
    {
        id: 3,
        projecttitle: "Forest Green",
        projectrole:"UI Designer, UX Designer, Shopify Developer, React Developer",
        description:"E-Commerce site for eco-friendly products.  Built the front-end using React Framework and the backend is based on the shopify-buy sdk",
        projectimage:"/assets/images/ForestGreenHomepage.png",
        onedescription:"A Shopify Site built using the React Framework and shopify-buy sdk",
        projectprompt:"Design a shopify site that makes it easy for consumers who want to live a more eco-friendly/ sustainable life.",
        problem:"There is no place on the internet for a sustainbly-minded consumer to easily find eco-friendly products.",
        goal:"Design a website that not only makes it easy to find eco-friendly products, but also teaches users how to live a more eco-friendly lifestyle.",
        myrole:"Programmer, Website Designer, UI Designer, Shopify Developer",
        painpointstitle1:"Lack of products",
        painpointstitle2:"Lack of education",
        painpointstitle3:"Lack of style",
        painpointscontent1:"No place to find sustainable products on the internet",
        painpointscontent2:"Users need a place to learn how to live a sustainable and eco-friendly lifestyle, that is free of judgement",
        painpointscontent3:"Most of the smaller eco-friendly e-commerce sites have either bad UI or are linked to an outside source for product-buying(linked to an Amazon page).",
        figmalink:"https://www.figma.com/file/ZEKWzEG8ItchtkJ9bUkO7q/Forest-Green-Project-Design-System?node-id=0%3A1",
        sitescreenshot1:"/assets/images/ForestGreenScreenshot1.png",
        sitescreenshot2:"/assets/images/ForestGreenScreenshot2.png",
        sitescreenshot3:"/assets/images/ForestGreenScreenshot3.png",
        websitelink:"https://forestgreenco.com/",
        githublink:"https://github.com/mrcmyk12/forestgreenshopify",
        impact:"A lot of people are interested in embracing the minimalist and sustainable lifestyle.  But, there are few places to go to learn how to accomplish this lifestyle. as well as where to get products to facilitate it.  Forest Green is a website that does both.",
        learned:"I learned all the steps it takes to create a headless chopify website.  As well as the things that go into managing a Shopify store like marketing, inventory, site updates, graphic design, and even blogging.",
        steptitle1:"More products",
        steptitle2:"More kits",
        steptitle3:"A more robust blog",
        step1:"Add more products to the catalog.  It is pretty limited right now, however, once I find more American-based distributors it should create a more user-friendly experience.",
        step2:"Create kit-themed pages in order to guide users towards what products go together for a specific task they are trying to accomplish.",
        step3:"Create more blog posts, that help the user navigate their eco-friendly and sustainable lifestyle.  This will create a better user-experience and guidance for those new to the lifestyle."
    },
	{
		id: 0,
